...
def split_content_into_batches(
    ...
    if format_type in ("wework", "bark"):
        ...
        if update_info:
            base_footer += f"\n<font color='grey'>Ptilopsis Radar 发现新版本 {update_info['remote_version']}，当前 {update_info['current_version']}</font>"
        ...
        if update_info:
            base_footer += f"\n_Ptilopsis Radar 发现新版本 *{update_info['remote_version']}*，当前 *{update_info['current_version']}_"
