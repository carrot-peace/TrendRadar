...
def render_html_content(
    ...
    *,
    ...
    <body>
        ...
        <div class="container">
            <div class="header">
                <div class="header-watermark">Ptilopsis Radar</div>
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    由 <span class="project-name">Ptilopsis Radar</span> 生成 ·
        ...
        <script>
            ...
            async function saveAsImage(e) {
                ...
                try {
                    ...
                    const now = new Date();
                    const filename = `Ptilopsis Radar_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}.png`;
            ...
            async function saveAsMultipleImages(e) {
                ...
                try {
                    ...
                    // 下载所有图片
                    const now = new Date();
                    const baseFilename = `Ptilopsis Radar_热点新闻分析_${now.getFullYear()}${String(now.getMonth() + 1).padStart(2, '0')}${String(now.getDate()).padStart(2, '0')}_${String(now.getHours()).padStart(2, '0')}${String(now.getMinutes()).padStart(2, '0')}`;
            ...
            function saveAsMarkdown() {
                ...
                lines.push('# ' + (headerTitle ? headerTitle.textContent.trim() : 'Ptilopsis Radar'));
                lines.push('');
                ...
                // 页脚
                lines.push('---');
                lines.push('*Generated by Ptilopsis Radar*');

                // 下载
                var md = lines.join('\\n');
                var blob = new Blob([md], { type: 'text/markdown;charset=utf-8' });
                var link = document.createElement('a');
                var filename = 'Ptilopsis Radar_' + dateStr + '_' + timeStr.replace(':', '') + '.md';
                link.download = filename;
